              ...
              <div className={styles.generalInfo}>
                ...
                <Row style={{ marginTop: 15 }}>
                  <Col span={12} className={styles.singleGeneralInfo}>
                    ...
                    <span className={styles.hightLightInfo}>{user.firstName+" "+user.lastName}</span>
                  </Col>
                  <Col span={12} className={styles.singleGeneralInfo}>
                    <span>លេខសំបុត្រកំណើត</span>
                    <span className={styles.hightLightInfo}>{user.birthCertificateNum}</span>
                  </Col>
                  <Col span={12} className={styles.singleGeneralInfo}>
                    <span>គោត្តនាម និង​នាម ឡាតាំង</span>
                    <span className={styles.hightLightInfo}>{user.firstNameLatin+" "+user.lastNameLatin}</span>
                  </Col>
                  <Col span={12} className={styles.singleGeneralInfo}>
                    <span>លេខអត្តសញ្ជាតិខ្មែរ</span>
                    <span className={styles.hightLightInfo}>{user.nationalityIDNum}</span>
                  </Col>
                  <Col span={12} className={styles.singleGeneralInfo}>
                    <span>ភេទ</span>
                  ...
                  <Col span={12} className={styles.singleGeneralInfo}>
                    ...
                    <span className={styles.hightLightInfo}>{user.passportNumber}</span>
                  </Col>
                  <Col span={12} className={styles.singleGeneralInfo}>
                    <span>ថ្ងៃខែឆ្នាំកំណើត</span>
                    <span className={styles.hightLightInfo}>{user.birthDate}</span>
                  </Col>
                  <Col span={12} className={styles.singleGeneralInfo}>
                    <span>លេខទូរស័ព្ទ</span>
                    <span className={styles.hightLightInfo}>{user.contactInfo?.phoneNumber1}</span>
                  </Col>
                  <Col span={12} className={styles.singleGeneralInfo}>
                    <span>អត្តលេខមន្រ្ដីរាជការ</span>
                    <span className={styles.hightLightInfo}>input form does not exist</span>
                  </Col>
                  <Col span={12} className={styles.singleGeneralInfo}>
                    <span>អ៊ីម៉ែល</span>
                    <span className={styles.hightLightInfo}>{user.contactInfo?.email}</span>
                  </Col>
